...
export IOC=ioc-rix-at1k2-calc

# IOC startup command
export IOC_COMMAND="ioc-kfe-at1k2-calc --list-pvs --production --system=AT1K2 --autosave_path=/reg/d/iocData/ioc-rix-at1k2-calc/iocInfo/autosave.json"

# IOC PV prefix.
export PREFIX=AT1K2:CALC
